...
namespace Netfuser.Dnext.Impl
{
    struct RecursionCounter
    {
        ...
        /// <summary>
        /// Increments <see cref="_counter"/> if it's not too high. <c>ALL</c> instance methods
        ...
        {
            if (_counter >= MAX_RECURSION_COUNT)
                return false;
            _counter++;
            return true;
        }
        ...
        /// <inheritdoc/>
        public override string ToString() => _counter.ToString();
    }
}